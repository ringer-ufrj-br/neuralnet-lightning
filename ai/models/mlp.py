...
class ModelMLP(pl.LightningModule):
    ...
    def __init__(
        ...
        # time: AUROC alone re-sorted its whole buffer on every one of the ~10k steps an epoch.
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        set at the default 0.5 decision boundary, used by EarlyStopping/ModelCheckpoint, and
        logs the accumulated validation metrics for the epoch.
        """
